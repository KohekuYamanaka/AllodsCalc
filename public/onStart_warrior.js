butt = document.getElementsByClassName('wbutton')
...
function createWindow(event)
{
    ...
    needs_id = '#w'+button.name.replace('warrior','')+'rank'+button.rank;
    ...
    divtable = document.querySelector('.warrior table');
...
function OK()
{
    ...
    RD = parseInt(document.getElementById('one_weapon_damage').value);
...
function tableSuperviser()
{
	...
	trs = document.querySelectorAll('.warrior table tr');
	buttonRows = [];
