butt = document.getElementsByClassName('pbutton')
...
function createWindow(event)
{
    ...
    needs_id = '#p'+button.name.replace('psionic','')+'rank'+button.rank;
    ...
    divtable = document.querySelector('.psionic table');
    ...
    divbard = document.querySelector('.psionic');
...
function tableSuperviser()
{
    ...
    trs = document.querySelectorAll('.psionic table tr');
    buttonRows = [];
